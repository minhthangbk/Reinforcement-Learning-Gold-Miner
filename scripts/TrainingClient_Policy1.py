...
from MinerEnv_v1 import MinerEnv_v1 # A class of creating a communication environment between the DQN model and the GameMiner environment (GAME_SOCKET_DUMMY.py)
...
BATCH_SIZE = 256   #The number of experiences for each replay
